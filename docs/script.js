...
function setupApiContent(gtw) {
    ...
    // Create scrollable container for category navigation
    ...
    // Render all endpoints initially
    ...
    categoryNav.addEventListener('click', function(e) {
        if (e.target.classList.contains('category-tag')) {
            ...
            // Scroll the active tag into view
...
// New function to render endpoints based on selected category
function renderEndpoints(endpoints, selectedCategory) {
    ...
    endpoints.forEach(category => {
        // Skip if not the selected category (unless 'all')
...
// Keep the existing createApiItemElement function the same
// Update the createApiItemElement function
...
// Update the openApiModal function
function openApiModal(name, endpoint, description, method) {
    ...
    // Generate parameter input dari URL
    ...
    submitApiBtn.onclick = async function () {
        ...
        try {
            ...
            // Tambah parameter lainnya jika ada
