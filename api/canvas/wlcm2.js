...
module.exports = {
  name: 'Welcome2', // Ganti jadi goodbye2, promote2, demote2 untuk masing-masing file
  ...
  async run(req, res) {
    const { avatar, background, description, borderColor, avatarBorderColor, overlayOpacity } = req.query;
    ...
    if (!avatar || !background || !description || !borderColor || !avatarBorderColor || !overlayOpacity)
      return res.status(400).json({ status: false, error: 'Semua parameter wajib diisi!' });
